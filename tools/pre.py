...
dataset_dir_vi = '/root/JDet/test/testimg' # RGB
output_dir_vi = '/root/JDet/test/images'
dataset_dir_ir = '/root/JDet/test/testimgr' # IR
output_dir_ir = '/root/JDet/test/images_ir'
